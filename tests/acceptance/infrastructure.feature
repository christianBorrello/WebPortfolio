Feature: Infrastructure Quality -- SEO, Performance, and Accessibility
  ...
  @infrastructure @milestone-2 @skip
  Scenario: Home page has proper meta tags for search engines
  ...
  @infrastructure @milestone-2 @skip
  Scenario: Case study pages have unique meta tags
  ...
  @infrastructure @milestone-2 @skip
  Scenario: Sitemap is generated and accessible
  ...
  @infrastructure @milestone-1 @skip
  Scenario: Heading hierarchy is semantically correct
    Given a visitor navigates to the homepage
  ...
  @infrastructure @milestone-1 @skip
  Scenario: Contact form inputs have associated labels
  ...
  @infrastructure @milestone-1 @skip
  Scenario: Text contrast meets minimum accessibility standards
    Given a visitor navigates to the homepage
  ...
  @infrastructure @walking-skeleton @skip
  Scenario: No tracking cookies or analytics in version one
    Given a visitor navigates to the homepage
  ...
  @infrastructure @milestone-1 @skip
  Scenario: Navigation links scroll to the correct sections
  ...
  @infrastructure @milestone-2 @skip
  Scenario: Locale routing works correctly
